 ...
 * @version 2021-02-04
 */
public class GuiHarmonicOscilator extends CodingTrainGui implements SimulationView {
     ...
     */
    public GuiHarmonicOscilator(int width, int height, int frameRate) {
    ...
    public void setup() {
        ...
        ModelHarmonicOscillator model = new ModelHarmonicOscillator(box);
    ...
    public static void main(String[] args) {
        new GuiHarmonicOscilator(600,600,30);
    }
